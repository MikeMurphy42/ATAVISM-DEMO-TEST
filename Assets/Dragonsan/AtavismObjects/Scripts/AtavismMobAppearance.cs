          ...
          //  Debug.LogError("DeactivateModularArmor "+slot);
            ...
            if (_modularCustomizationManager)
            {
                 ...
                 if ((_modularCustomizationManager.lowerlegSlot) == slot && _modularCustomizationManager.ActiveLowerLegs.Count > 0)
                {
                 ...
                 if ((_modularCustomizationManager.lowerlegSlot) == slot  && _modularCustomizationManager.ActiveFeet.Count > 0 && _modularCustomizationManager.ActiveLowerLegs.Count == 0)
                ...
                //   if ((activeDisplay.equipDisplay.socket == AttachmentSocket.LeftFoot || activeDisplay.equipDisplay.socket == AttachmentSocket.RightFoot) && _modularCustomizationManager.ActiveFeet)
                {
                 ...
                 if ((_modularCustomizationManager.feetSlot) == slot  && _modularCustomizationManager.ActiveLowerLegs.Count > 0 && _modularCustomizationManager.ActiveFeet.Count == 0)
