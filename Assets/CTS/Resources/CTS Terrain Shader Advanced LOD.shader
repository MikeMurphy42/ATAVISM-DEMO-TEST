Shader "CTS/CTS Terrain Shader Advanced LOD"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			fixed localTangent77407740 = ( 0.0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localTangent77407740).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult7710 = (fixed2(1.0 , ( _Global_Color_Map_Far_Power * ( tex2DNode7708.a * _Global_Color_Opacity_Power ) )));
			...
			float4 layeredBlend6512 = ( lerp( lerp( lerp( lerp( float4( 1,0,0,0 ) , Texture_1_Final950 , layeredBlendVar6512.x ) , Texture_2_Final3385 , layeredBlendVar6512.y ) , Texture_3_Final3451 , layeredBlendVar6512.z ) , Texture_4_Final3518 , layeredBlendVar6512.w ) );
